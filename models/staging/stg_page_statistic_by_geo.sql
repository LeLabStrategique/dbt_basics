...
WITH source_data AS (
    ...
    SELECT
        ...
        d.value AS geo_name_enriched
        
    FROM 
        -- Source de faits : page_statistic_by_geo
    ...
    SELECT
        *,
        ...
        CONCAT(
            ...
            ' - ', 
            COALESCE(geo_name_enriched, CAST(geo_id AS STRING)) 
        ) AS row_id,
...
SELECT
    ...
    geo_id,
    COALESCE(geo_name_enriched, CAST(geo_id AS STRING)) AS dim_split_geo,
